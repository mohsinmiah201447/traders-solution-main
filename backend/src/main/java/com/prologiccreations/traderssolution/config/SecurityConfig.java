...
//
//import com.prologiccreations.traderssolution.filter.auth.AuthFilter;
...
//
//    public static final String[] authIgnoreList = new String[]{"/login", "/refresh", "/logout", "/logout/*", "/apps/**", "/css/**", "/lib/**"};
